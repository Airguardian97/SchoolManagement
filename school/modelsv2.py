...
class Grade(models.Model):
    stud = models.OneToOneField('Student', models.DO_NOTHING, db_column='Stud_ID', primary_key=True)  # Field name made lowercase. The composite primary key (Stud_ID, subject_Code, stud_Grade, grading_Period) found, that is not supported. The first column is selected.
